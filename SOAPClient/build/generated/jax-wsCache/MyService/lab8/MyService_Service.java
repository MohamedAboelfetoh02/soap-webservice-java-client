 ...
 * 
 */
@WebServiceClient(name = "MyService", targetNamespace = "http://lab8/", wsdlLocation = "http://localhost:8080/SOAPProject/MyService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICE_QNAME = new QName("http://lab8/", "MyService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SOAPProject/MyService?wsdl");
    ...
    public MyService getMyServicePort() {
        return super.getPort(new QName("http://lab8/", "MyServicePort"), MyService.class);
    }
    ...
    public MyService getMyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab8/", "MyServicePort"), MyService.class, features);
    }
